...
function DeleteCardPopup({ isDeletePopupOpen, closeAllPopups, onConfirmDelete, isDeleting }) {
    ...
    return(
        <PopupWithForm name="delete" title="Удаление" isOpen={isDeletePopupOpen} onClose={closeAllPopups} >
                ...
                <button type="button" className="popup-container__delete-button popup__button" onClick={handleConfirmClick} buttonText={isDeleting ? "Удаление..." : "Да"} >Да</button>
        </PopupWithForm>
    )
}
