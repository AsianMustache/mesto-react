        ...
        <main className="content">
            <section className="profile">
                ...
                <div className="profile__info">
                  ...
                  <button type="button" className="profile__info-edit-button"><img src={edit} className="profile__info-edit-button-image" alt="Редактирование кнопка" /></button>
                </div>
                <button type="button" className="profile__add-button"><img src={plus} alt="Добавление" className="profile__add-button-image" /></button>
              </section>
